...
class Fetch(MOQTMessage):
    ...
    def serialize(self, *, draft: int) -> Buffer:
        ...
        if is_draft16_or_later(draft):
            ...
            MOQTMessage._serialize_params(payload, params, draft=draft)
        else:
    ...
    @classmethod
    def deserialize(cls, buf: Buffer, *, draft: int, buf_end: Optional[int] = None) -> 'Fetch':
        namespace = None
        track_name = None
        start_group = None
        start_object = None
...
class FetchOk(MOQTMessage):
    ...
    @classmethod
    def deserialize(cls, buf: Buffer, *, draft: int, buf_end: Optional[int] = None) -> 'FetchOk':
...
class FetchError(MOQTMessage):
    ...
    @classmethod
    def deserialize(cls, buf: Buffer, *, draft: int, buf_end: Optional[int] = None) -> 'FetchError':
...
class FetchCancel(MOQTMessage):
    ...
    @classmethod
    def deserialize(cls, buf: Buffer, *, draft: int, buf_end: Optional[int] = None) -> 'FetchCancel':
